...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 15 13:00:20 2021
...
filenames = [
  "artificial/3-spiral.arff",
  "artificial/complex8.arff",
...
if len(points[0]) == 2:
  # plot 2D
  fig = plt.scatter(*zip(*points), c=clusterer.labels_)
elif len(points[0]) == 3:
  # plot 3D
  ax = plt.axes(projection='3d')
  ax.scatter3D(*zip(*points), c=clusterer.labels_)
else:
